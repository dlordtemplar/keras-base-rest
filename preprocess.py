...
transformations = [('heavy_clean', Text.heavy_clean), ('clean', Text.clean), ('tokenize', Text.tokenize),
                   ('spell_check', Text.spell_check),
...
print('dataset: answer_texts_train, answer_texts_dev')
...
# print('dataset: test2016, test2016_')
# for dataset in [test2016, test2016_]:
#     for idx, row in dataset.iterrows():
#         dataset.at[idx['question']] = Text(row['question'], 'question', idx)
#         if 'answer' in row.keys():
#             dataset.at[idx['answer']] = Text(row['answer'], 'question', idx)
#     for transformation in transformations:
#         dataset = transform_dataset(dataset, transformation)

# print('dataset: answer_texts_test2016')
